...
Private Sub Command1_Click()
    ...
    'If GetIndex = 0 Then
    If Op(0).value = False And Op(1).value = False And Op(2).value = False Then
    ...
    AddtoRichTextBox frmMain.RecTxt, "Tamaño mínimo 20 caracteres, no se permiten mensajes del tipo 'GM Veni pls' y parecidos.", 255, 255, 255, 1, 1
        Exit Sub

    End If

    If InStr(1, txtMotivo, ",") Then
        MsgBox "Imposible mandar un mensaje GM con el signo ',' (Coma) adentro del mensaje, edita el mensaje y volve a enviarlo.", vbCritical, _
                "Error #85"
        Exit Sub
