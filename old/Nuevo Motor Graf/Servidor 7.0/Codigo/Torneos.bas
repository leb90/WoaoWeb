...
Sub EnviarTorneo(index As Integer)
    ...
    Next
    Call SendData2(ToTorneo, index, 0, 91, TorneoPluto.FaseTorneo & "," & TorneoPluto.Creador & "," & _
                                           TorneoPluto.Ttip & "," & TorneoPluto.Tcua & "," & TorneoPluto.Tpj & "," & TorneoPluto.Tmax & "," & _
                                           TorneoPluto.Tmin & "," & TorneoPluto.Tins & "," & Participantes)
