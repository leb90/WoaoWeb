...
Private Sub Auditoria_Timer()
    ...
    'For i = 1 To MaxUsers
    'If UserList(i).flags.TiempoRev > 0 Then
    'UserList(i).flags.TiempoRev = UserList(i).flags.TiempoRev - 1
    'End If
    'Next i
    ...
    If Conteo = True Then
        ...
        If Cuenta2 > 0 Then
            Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
        End If
    
        If Cuenta2 = 0 Then
            Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| Comienza la batalla, buenas suerte." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| Comienza la batalla, buenas suerte." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| Comienza la batalla, buenas suerte." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| Comienza la batalla, buenas suerte." & "´" & FontTypeNames.FONTTYPE_talk)
    ...
    If Conteo1 = True Then
        ...
        If Cuenta1 = 5 Then
            Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 5 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 5 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
        End If
    
        If Cuenta1 = 4 Then
            Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 4 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 4 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
        End If
    
        If Cuenta1 = 3 Then
            Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 3 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 3 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
        End If
    
        If Cuenta1 = 2 Then
            Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 2 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 2 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
        End If
    
        If Cuenta1 = 1 Then
            Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 1 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 1 Segundos." & "´" & FontTypeNames.FONTTYPE_talk)
        End If
    
        If Cuenta1 = 0 Then
            Call SendData(ToIndex, Pareja.Jugador1, 0, "|| Comienza la batalla, buenas suerte." & "´" & FontTypeNames.FONTTYPE_talk)
            Call SendData(ToIndex, Pareja.Jugador2, 0, "|| Comienza la batalla, buenas suerte." & "´" & FontTypeNames.FONTTYPE_talk)
...
fuera3:
                ...
                If UserGranPoder = "" And i = tt And UserList(i).flags.Muerto = 0 And UserList(i).flags.Privilegios = _
                   0 And NumUsers > NumeroGranPoder Then
    ...
    If MinutosCastilloNorte > 30 Then
        ...
        For ii = 1 To Guilds.Count
            ...
            If UCase$(castillo1) = UCase$(Guilds(ii).GuildName) Then
                ...
                Next
                'nati: Calcula la gente online en el Clan
                Guilds(ii).Reputation = Guilds(ii).Reputation + (NumUsers - OnlineClanRecompensa / 2) + 5
        ...
        If UserList(iuserindex).ConnID <> -1 Then
            ...
            If UserList(iuserindex).ConnIDValida And UserList(iuserindex).flags.UserLogged Then
                ...
                'Call ControlaSalidas(iuserindex, UserList(iuserindex).Pos.Map, UserList(iuserindex).Pos.X, UserList(iuserindex).Pos.Y)
                    ...
                    If MapInfo(UserList(iuserindex).Pos.Map).Terreno = "TORNEO" Or MapInfo(UserList(iuserindex).Pos.Map).Terreno = "TORNEOGM" Or MapInfo(UserList(iuserindex).Pos.Map).Terreno = "EVENTO" Or UserList(iuserindex).Pos.Map = 203 Or _
...
vampi:
                ...
                Else    'ESTA MUERTO
                    ...
                    'PLUTO:6.2
                    If MapInfo(UserList(iuserindex).Pos.Map).Terreno = "TORNEO" Or MapInfo(UserList(iuserindex).Pos.Map).Terreno = "TORNEOGM" Or (UserList(iuserindex).Pos.Map = MapaTorneo2 And MinutoSinMorir > 3) Then
...
Private Sub Timer2_Timer()
    ...
    End If
        ...
        If BloodComienza = 1 Then
        BloodGames_Comienza (10)
        ElseIf BloodComienza = 0 Then
...
Private Sub tLluvia_Timer()
    ...
    If Lloviendo Then
        ...
        For iCount = 1 To LastUser
            Call RecStamina(iCount, True, StaminaIntervaloDescansar)
            Call SendUserStatsEnergia(iCount)
    ...
    For i = 1 To LastUser
        ...
        With UserList(i)
            ...
            If .flags.UserLogged Then
                ...
                'pluto:6.0A--------
                If .flags.Sed > 0 Or .flags.Hambre > 0 Then Call QuitarSta(i, 40)
                ...
                If .flags.Privilegios > 0 Or .flags.Muerto > 0 Then GoTo yupi2

                If .Pos.Map <> Mapcasa And .Pos.Map <> Mapcasa2 Then GoTo yupi
                Dim Casa As Byte
                ...
                If Casa = 51 Or Casa = 30 Or Casa = 31 Then
                    ...
                    If .Pos.Map = Mapcasa Then Call TirarOro(30000, i) Else Call TirarOro(10000, i)
                    Call SendUserStatsOro(i)
                    Call SendData2(ToPCArea, i, .Pos.Map, 22, .Char.CharIndex & "," & 33 & "," & 1)

                End If

                If Casa = 52 And .flags.Morph = 0 And .flags.Navegando = 0 And UserList(i).flags.Invisible = 0 And .flags.Angel = 0 And .flags.Demonio = 0 Then
                    ...
                    '[gau]
                    Call ChangeUserChar(ToMap, 0, .Pos.Map, i, val(6), val(0), .Char.Heading, .Char.WeaponAnim, .Char.ShieldAnim, .Char.CascoAnim, .Char.Botas, .Char.AlasAnim)
                    Call SendData2(ToPCArea, i, .Pos.Map, 22, .Char.CharIndex & "," & 33 & "," & 1)
                    Call SendData(ToMap, 0, Map, "TW" & 115)
                ...
                If Casa > 53 And Casa < 57 And .flags.Paralizado = 0 Then
                    Call SendData(ToIndex, i, 0, "|| Los Espiritus de la Casa te han Paralizado." & "´" & FontTypeNames.FONTTYPE_talk)
                    Call SendData(ToMap, 0, Map, "TW" & 115)
                    Call SendData2(ToPCArea, i, .Pos.Map, 22, .Char.CharIndex & "," & 33 & "," & 1)
                    .flags.Paralizado = 1
                    .Counters.Paralisis = IntervaloParalisisPJ
                    Call SendData2(ToIndex, i, 0, 68)
                    Call SendData2(ToIndex, i, 0, 15, .Pos.X & "," & .Pos.Y)
...
yupi:
                ...
                If ((.Pos.Map > 14 And .Pos.Map < 18) Or (.Pos.Map > 20 And UserList(i).Pos.Map < 22)) Then
...
yupi2:
                ...
                If .Stats.GLD + .Stats.Banco > MoroOn Then
                    MoroOn = .Stats.GLD + .Stats.Banco
                    NMoroOn = .Name
                ...
                If Not Criminal(i) And nvv > NivCiuON Then
                    NivCiuON = nvv
                    NNivCiuON = .Name
                End If


                If Criminal(i) And nvv > NivCrimiON Then
                    NivCrimiON = nvv
                    NNivCrimiON = .Name
                End If
...
alli:
                ...
                If MapData(.Pos.Map, .Pos.X, .Pos.Y).trigger = 3 Then
                ...
                Else
                    ...
                    If .Counters.PiqueteC > 0 Then .Counters.PiqueteC = 0
                  
                End If

                'pluto:2.12
                If .Pos.Map = MapaTorneo2 And .Torneo2 > Torneo2Record Then
                    Torneo2Record = .Torneo2
                    Torneo2Name = .Name
                ...
                '¿Hay algun obj?
                If MapData(.Pos.Map, .Pos.X, .Pos.Y).OBJInfo.ObjIndex > 0 And .flags.Muerto = 1 Then
                    .Counters.bloqueo = .Counters.bloqueo + 1
                    Call SendData(ToIndex, i, 0, "E2")

                    If .Counters.bloqueo > 10 Then
                        .Counters.bloqueo = 0
            ...
            If segundos > 6 Then
                ...
                If .Char.FX > 37 And .Char.FX < 68 Then
                    Call SendData2(ToMap, i, .Pos.Map, 22, .Char.CharIndex & "," & 0 & "," & 0)
                    .Char.FX = 0
            ...
            'pluto:2.11
            If segundos > 12 And .GranPoder > 0 Then
                Call SendData2(ToMap, i, .Pos.Map, 22, .Char.CharIndex & "," & 68 & "," & 1)
                .Char.FX = 68
                Call SendData(ToPCArea, i, .Pos.Map, "TW" & 147)

            End If

            'If Segundos >= 18 Then
            If segundos >= 18 Then .Counters.Pasos = 0
            'End If
