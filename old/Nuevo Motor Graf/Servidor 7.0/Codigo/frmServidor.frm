...
Private Sub Command3_Click()
    ...
    If MsgBox( _
       "¡¡Atencion!! Si reinicia el servidor puede provocar la perdida de datos de los usarios. ¿Desea reiniciar el servidor de todas maneras?", _
       vbYesNo) = vbYes Then
        Me.Visible = False
        Call Restart
